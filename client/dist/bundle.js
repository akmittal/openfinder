...
</dom-module>`));document.head.appendChild(Vl.content);let Fl,Dl=e=>e;class Bl extends(tr(Fs(Rs(Os(Wi))))){static get template(){return yt(Fl||(Fl=Dl`
    <style>
      :host {
        display: inline-block;
      }
...
`))),Ed.register("vaadin-grid-styles");let Td,kd=e=>e;const Id=(()=>{try{return document.createEvent("TouchEvent"),!0}catch(e){return!1}})();class Pd extends(tr(Rs(rd(td(od(Zl(hd(cd(ud(dd(wd(Xl(ad(xd(id(nd(Ad(pd(Kl))))))))))))))))))){static get template(){return yt(Td||(Td=kd`
